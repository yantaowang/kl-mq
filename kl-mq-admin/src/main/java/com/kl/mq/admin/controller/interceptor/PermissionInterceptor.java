package com.kl.mq.admin.controller.interceptor;

import com.Kl.mq.admin.controller.annotation.PermessionLimit;
import com.Kl.mq.admin.core.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter implements InitializingBean {
    ...
    @Value("${Kl.mq.login.username}")
    private String username;
    @Value("${Kl.mq.login.password}")
	...
	public static final String LOGIN_IDENTITY_KEY = "Kl_MQ_LOGIN_IDENTITY";
