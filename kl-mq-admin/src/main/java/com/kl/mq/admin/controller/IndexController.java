...
import com.Kl.mq.admin.controller.interceptor.PermissionInterceptor;
...
public class IndexController {
	...
	public String index(Model model, HttpServletRequest request) {
		...
		Map<String, Object> dashboardMap = KlMqMessageService.dashboardInfo();
	...
	public ReturnT<Map<String, Object>> chartInfo(Date startDate, Date endDate) {
		ReturnT<Map<String, Object>> chartInfo = KlMqMessageService.chartInfo(startDate, endDate);
		return chartInfo;
	}
