 ...
 */
@Mapper
public interface IKlMqMessageDao {

    // ---------------------- admin api ----------------------

    // 精确查询 topic
    public List<KlMqMessage> pageList(@Param("offset") int offset,
    ...
    public int update(@Param("message") KlMqMessage message);


    // ---------------------- broker api ----------------------

    public int save(@Param("messageList") List<KlMqMessage> messageList);

    public List<KlMqMessage> pullNewMessage(@Param("newStatus") String newStatus,
                                             @Param("topic") String topic,
    ...
    public int updateStatus(@Param("messageList") List<KlMqMessage> messageList);
